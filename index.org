...
[[https://github.com/cask/cask][Cask]] 是一个 Emacs Lisp 的项目管理工具，一般用于开发 Emacs Lisp Package。这里还是以 GNU ELPA 和 MELPA 为例，在 Cask 文件中添加：
...
镜像每两小时[[https://travis-ci.org/emacs-china/elpa/builds][更新]]一次。
